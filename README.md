...
**PR head branch:** _.github/workflows/ci.yml_
...
**default branch:** _.github/workflows/test-report.yml_
...
Test execution must be configured to produce _Visual Studio Test Results_ files (TRX).
